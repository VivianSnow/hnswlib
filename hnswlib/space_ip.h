...
// Favor using AVX if available.
    ...
    static float
    InnerProductFP16SIMD32Ext(const void *pVect1v, const void *pVect2v, const void *qty_ptr) {
        float PORTABLE_ALIGN32 TmpRes[8];
        float *pVect1 = (float *) pVect1v;
        float *pVect2 = (float *) pVect2v;
        size_t qty = *((size_t *) qty_ptr);
    ...
    class InnerProductSpaceFP16 : public SpaceInterface<uint16_t, float> {
    ...
    public:
        InnerProductSpaceFP16(size_t dim) {
            fstdistfunc_ = InnerProductFP16SIMD32Ext;
            dim_ = dim;
